            ...
            <div className="mt-6 flex flex-wrap items-center gap-x-3 gap-y-2">
              ...
              {socialLinks.map((social) => (
                <a
                  ...
                  className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-md text-cream/80 transition-colors hover:text-cream focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cream"
                >
                  {social.icon}
                </a>
              ))}
